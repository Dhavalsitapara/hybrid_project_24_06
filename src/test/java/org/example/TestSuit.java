...
public class TestSuit extends BaseTest {
    ...
    @Test
    public void userShouldBeAbleToAddAProductToBaskets() {
        ...
        //Check if the product has been added to the basket by verifying product := build your own computer
    ...
    public void onlyRegisteredUserShouldBeAbleToVote() {
        ...
        registrationSuccesPage.verifyUserRegisteredSuccessfully();
